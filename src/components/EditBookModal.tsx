...
import { updateBookSchema, type UpdateBookFromValues } from "@/validators/CreateBookSchema";
...
export default function EditBookModal({ open, onClose, book, onSubmit, isLoading }: Props) {
